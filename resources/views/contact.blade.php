      ...
      <div class="container">
        ...
        <div class="row block-9">
          <div class="col-md-6 order-md-last pr-md-5">
            <form action="/seller-contact-view" method="post">
              @csrf
              <div class="form-group">
                <input type="text" name="seller_name" class="form-control" placeholder="Your Name">
              </div>
              <div class="form-group">
                <input type="text" name="seller_email" class="form-control" placeholder="Your Email">
              </div>
              <div class="form-group">
                <input type="text" name="seller_furniture" class="form-control" placeholder="Your Furniture">
              </div>
              <div class="form-group">
                <textarea id="" name="seller_message" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
              </div>
              <div class="form-group">
