...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index">Klift</a>
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="index">Home</a></span> <span>Project</span></p>
            </div>
				...
				<a href="">
					<div class="col-md-6 col-lg-4 ftco-animate">
						<div class="project">
							...
							<a href="images/work-2.jpg" class=" image-popup d-flex justify-content-center align-items-center">
							</a>
						</div>
					</div>
				</a>
